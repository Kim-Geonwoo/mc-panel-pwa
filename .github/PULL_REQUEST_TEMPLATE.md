...
- [ ] `npx tsc --noEmit` 통과, `npm run build` 성공 (web/) / `npx tsc --noEmit` passes, `npm run build` succeeds (web/)
- [ ] 새 기능에는 테스트 추가/갱신 (해당 시) / Tests added or updated for new functionality (where applicable)
