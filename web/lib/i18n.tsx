...
const dict: Record<Lang, Record<string, string>> = {
  ko: {
    ...
    "studio.inspector.noProps": "속성 없음",
    "studio.inspector.delete": "블록 삭제",
    "studio.text.i18nKey": "사전 키",
    "studio.text.i18nNone": "직접 입력",
    "studio.text.ko": "문구(한국어)",
    "studio.text.en": "문구(영어)",
    "studio.text.variant": "모양",
    "studio.text.variantTitle": "제목",
    "studio.text.variantBody": "본문",
    "studio.text.variantCaption": "캡션",
    "studio.logo.size": "크기(px)",
  ...
  en: {
    ...
    "studio.inspector.noProps": "No properties",
    "studio.inspector.delete": "Delete block",
    "studio.text.i18nKey": "Dictionary key",
    "studio.text.i18nNone": "Custom text",
    "studio.text.ko": "Text (Korean)",
    "studio.text.en": "Text (English)",
    "studio.text.variant": "Style",
    "studio.text.variantTitle": "Title",
    "studio.text.variantBody": "Body",
    "studio.text.variantCaption": "Caption",
    "studio.logo.size": "Size (px)",
